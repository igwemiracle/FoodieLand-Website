...
const AsideFoodieRecipe = () => {
  return (
    <aside className="basis-[45%] flex flex-col gap-6">
      <h1 className="ss:text-sm sm:text-2xl font-semibold">Other Recipe</h1>
      <div className="flex flex-col gap-5 ss:gap-3">
        {otherFoodRecipe.map((otherRecipe, index) => (
          <div key={index} className="flex lg:flex-row sm:px-0 lg:gap-12  items-center ss:flex-col ss:gap-2 lg:pr-2">
            ...
            <div className="flex flex-col gap-5">
              <h1 className="text-xl ss:text-[10px] ss:leading-4 sm:text-xl font-semibold leading-7">{otherRecipe.title}</h1>
