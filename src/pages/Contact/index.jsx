...
const ContactPage = () => {
  return (
    <div className="ss:mt-28 sm:mt-48">
      ...
      <div className='flex flex-col items-center gap-10 mx-auto mb-44'>
          ...
          <div className="flex flex-col gap-6 basis-[70%]">
            <div className="flex lg:flex-row ss:flex-col gap-6">
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  ss:placeholder:text-[10px] lg:placeholder:text-[16px] sm:placeholder:text-[12px]" />
                </div>
                <div>
                  <label className="text-gray-500 ss:text-[10px] lg:text-[16px] sm:text-[12px]
                  ">
            ...
            <div>
              ...
              <textarea placeholder="Enter your messages..." type="text"
                className="focus:outline-none mt-2 pl-5 pt-5 border border-solid border-gray-200 w-full lg:h-[365px] rounded-[16px] placeholder:text-[18px] resize-y
                ss:placeholder:text-[10px] lg:placeholder:text-[16px] sm:placeholder:text-[12px]" />
            </div>
            <div>
